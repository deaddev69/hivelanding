...
function HandWrittenTitle({
    title = "Hand Written",
    subtitle,
    className = "w-full max-w-4xl mx-auto py-24",
    textClassName = "text-4xl md:text-6xl text-black dark:text-white",
    ...
    return (
        <div className={`relative ${className}`}>
            ...
            <div className="relative text-center z-10 flex flex-col items-center justify-center">
                <motion.h1
                    className={`tracking-tighter flex items-center gap-2 ${textClassName}`}
